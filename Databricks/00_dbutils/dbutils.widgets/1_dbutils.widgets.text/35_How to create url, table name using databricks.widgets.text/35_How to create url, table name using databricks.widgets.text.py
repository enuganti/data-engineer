...
# MAGIC      dbutils.widgets.remove("input")
# MAGIC
...
PARAM_SCHEDULE_DATE = dbutils.widgets.get("SCHEDULE_DATE")
PARAM_SYSTEM_ID = dbutils.widgets.get("ENV_ID")
PARAM_DATABASE_NAME = dbutils.widgets.get("DATABASE_NAME")
...
print("PARAM_SYSTEM_ID:", PARAM_SYSTEM_ID)
...
URL_PREFIX = ("https://my" + PARAM_SYSTEM_ID + PARAM_API_URL + "&$format=json" + "&$inlinecount=allpages")
