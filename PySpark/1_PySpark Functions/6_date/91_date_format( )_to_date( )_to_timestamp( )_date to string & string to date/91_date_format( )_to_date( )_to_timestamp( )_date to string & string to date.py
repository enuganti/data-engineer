...
# MAGIC %md
# MAGIC #### **1) Convert date to string**
...
# MAGIC %md
# MAGIC #### **2) Convert string to timestamp**
# MAGIC
# MAGIC **input_timestamp, Last_transaction_date, Effective_Date, last_timestamp, pymt_timestamp**
...
# MAGIC %md
# MAGIC #### **3) Convert timestamp to string**
...
# MAGIC %md
# MAGIC #### **5) convert date to string data type**
