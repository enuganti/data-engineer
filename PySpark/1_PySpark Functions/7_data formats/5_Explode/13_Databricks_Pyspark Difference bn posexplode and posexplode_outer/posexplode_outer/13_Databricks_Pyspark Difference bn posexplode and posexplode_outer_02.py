...
# MAGIC - Unlike posexplode, 
# MAGIC   - if the **array/map** is **NULL /Empty** posexplode_outer function returns **NULL**, NULL for **pos and col** columns.
# MAGIC   - Similarly for the **map** it returns **rows with NULL's**.
